...
namespace Borbo.Equipment
{
    class VolatileAspect : EliteEquipmentBase
    {
        ...
        public override Material EliteOverlayMaterial { get; set; } = Main.assetBundle.LoadAsset<Material>(Main.assetsPath + "matVolatile.mat");
        ...
        private void CreateProjectile()
        {
            ...
            Material material1 = Main.assetBundle.LoadAsset<Material>(Main.assetsPath + "matVolatile.mat");
            ...
            if(body != null && body.healthComponent != null)
            {
                ...
                if (body.HasBuff(buffDef) && hc.alive && !hc.isInFrozenState)// && (!body.outOfDanger || !body.outOfCombat))
                {
                    ...
                    if (mortarTimer >= mortarInterval)
                    {
                        ...
                        forward.y = 0;
                        Vector3 fireDirection = forward + up * 2f;
